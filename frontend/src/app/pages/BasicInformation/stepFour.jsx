...
const StepFour = ({ handleNext, handlePrevious }) => {
  const [options, setOptions] = useState([
    { name: "Brass", selected: false },
    { name: "Conducting", selected: false },
    { name: "Composition", selected: false },
    { name: "Music Tech", selected: false },
    { name: "Piano", selected: false },
    { name: "Rearrangement", selected: false },
    { name: "Percussions", selected: false },
    { name: "Strings", selected: false },
    { name: "Transcription", selected: false },
    { name: "Woodwinds", selected: false },
  ]);
      ...
      <Form className="mt-40">
        <Form.Group className="mb-1">
          <Form.Label className="auth-title">
            What kind(s) of musical skill do you have?
          </Form.Label>
        </Form.Group>
        <Form.Group className="mb-4">
          <Form.Label className="desc-text-sec">
            We will help you put those skills to use
          </Form.Label>
        </Form.Group>
