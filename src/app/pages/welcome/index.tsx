        ...
        <Container fluid>
            <Row>
                ...
                <Col xs="12">
                    ...
                    <p className='desc-text text-center'>Let’s kickstart your journey by filling in some basic information</p>
                </Col>
                <Col xs='12' className='d-flex flex-column align-items-center justify-content-center mt-2 '>
                    <Button className='primary-btn' onClick={()=>navigate('/basicinfo')}>
                        Continue
                    </Button>
                    <Button className='secondary-btn mt-3' onClick={()=>navigate('/')}>
                    I’ll do this later
                    </Button>
                </Col>
            </Row>
